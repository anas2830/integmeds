                                    ...
                                    <div class="row gx-2">
                                        <div class="col-3">
                                            <div class="sidebar-bundle-img">
                                                <img class="img-fluid"
                                                    src="{{ asset('web_assets/images/bundle-img/Digestion-Constipation-Colon-Stomach-Gallbladder-support.png') }}"
                                                    alt="" title="">
                                            </div>
                                        </div>
                                ...
                                <a href="#">
                                    <div class="row gx-2">
                                        <div class="col-3">
                                            <div class="sidebar-bundle-img">
                                                <img class="img-fluid"
                                                    src="{{ asset('web_assets/images/bundle-img/Diabetes_Liver_Insulin-Resistance_weight-loss.png') }}"
                                                    alt="" title="">
                                            </div>
                                        </div>
                                        <div class="col-9 d-flex align-items-center">
                                ...
                                <a href="#">
                                    <div class="row gx-2">
                                        <div class="col-3">
                                            <div class="sidebar-bundle-img">
                                                <img class="img-fluid"
                                                    src="{{ asset('web_assets/images/bundle-img/Woman_Female-Hormone_Thyroid.png') }}"
                                                    alt="" title="">
                                            </div>
                                        </div>
                                        <div class="col-9 d-flex align-items-center">
                                ...
                                <a href="#">
                                    <div class="row gx-2">
                                        <div class="col-3">
                                            <div class="sidebar-bundle-img">
                                                <img class="img-fluid"
                                                    src="{{ asset('web_assets/images/bundle-img/Cancer-Support-and-Prevention.png') }}"
                                                    alt="" title="">
                                            </div>
                                        </div>
                                        <div class="col-9 d-flex align-items-center">
                                ...
                                <a href="#">
                                    <div class="row gx-2">
                                        <div class="col-3">
                                            <div class="sidebar-bundle-img">
                                                <img class="img-fluid"
                                                    src="{{ asset('web_assets/images/bundle-img/Autoimmune_Anti-Inflammatory.png') }}"
                                                    alt="" title="">
                                            </div>
                                        </div>
                                        <div class="col-9 d-flex align-items-center">
                                ...
                                <a href="#">
                                    <div class="row gx-2">
                                        <div class="col-3">
                                            <div class="sidebar-bundle-img">
                                                <img class="img-fluid"
                                                    src="{{ asset('web_assets/images/bundle-img/Bone-Joint-and-Muscle.png') }}"
                                                    alt="" title="">
                                            </div>
                                        </div>
                                        <div class="col-9 d-flex align-items-center">
                                ...
                                <a href="#">
                                    <div class="row gx-2">
                                        <div class="col-3">
                                            <div class="sidebar-bundle-img">
                                                <img class="img-fluid"
                                                    src="{{ asset('web_assets/images/bundle-img/Childrens-Health_-Children-Care-ages-4-and-older.png') }}"
                                                    alt="" title="">
                                            </div>
                                        </div>
                                        <div class="col-9 d-flex align-items-center">
                                ...
                                <a href="#">
                                    <div class="row gx-2">
                                        <div class="col-3">
                                            <div class="sidebar-bundle-img">
                                                <img class="img-fluid"
                                                    src="{{ asset('web_assets/images/bundle-img/Skin-Disease_-Vitiligo-Psoriasis-dermatitis-etc.png') }}"
                                                    alt="" title="">
                                            </div>
                                        </div>
                                        <div class="col-9 d-flex align-items-center">
                                    ...
                                    <div class="bundle-box">
                                        <a href="{{ route('bundle-details') }}">
                                            <div class="bundle-img">
                                                <img class="img-fluid"
                                                    src="{{ asset('web_assets/images/product-img/1620761771_May25MemorialDay_Ecomm_Scroller_2.avif') }}"
                                                    alt="" title="">
                                            </div>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="bundle-box">
                                        <a href="{{ route('bundle-details') }}">
                                            <div class="bundle-img">
                                                <img class="img-fluid"
                                                    src="{{ asset('web_assets/images/product-img/1620761771_May25MemorialDay_Ecomm_Scroller_3.avif') }}"
                                                    alt="" title="">
                                            </div>
                                            <div class="bundle-title">
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="bundle-box">
                                        <a href="{{ route('bundle-details') }}">
                                            <div class="bundle-img">
                                                <img class="img-fluid"
                                                    src="{{ asset('web_assets/images/product-img/1620761771_May25MemorialDay_Ecomm_Scroller_4.avif') }}"
                                                    alt="" title="">
                                            </div>
                                            <div class="bundle-title">
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="bundle-box">
                                        <a href="{{ route('bundle-details') }}">
                                            <div class="bundle-img">
                                                <img class="img-fluid"
                                                    src="{{ asset('web_assets/images/product-img/1620761771_May25MemorialDay_Ecomm_Scroller_6.avif') }}"
                                                    alt="" title="">
                                            </div>
                                            <div class="bundle-title">
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="bundle-box">
                                        <a href="{{ route('bundle-details') }}">
                                            <div class="bundle-img">
                                                <img class="img-fluid"
                                                    src="{{ asset('web_assets/images/product-img/1620761771_May25MemorialDay_Ecomm_Scroller_10.avif') }}"
                                                    alt="" title="">
                                            </div>
                                            <div class="bundle-title">
                                                <h3>Autoimmune</h3>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="bundle-box">
                                        <a href="{{ route('bundle-details') }}">
                                            <div class="bundle-img">
                                                <img class="img-fluid"
                                                    src="{{ asset('web_assets/images/product-img/1620761771_May25MemorialDay_Ecomm_Scroller_9.avif') }}"
                                                    alt="" title="">
                                            </div>
                                            <div class="bundle-title">
                                                <h3>Bone, Joint</h3>
                                ...
                                <div class="col-lg-3 col-6">
                                    <div class="bundle-box">
                                        <a href="{{ route('bundle-details') }}">
                                            <div class="bundle-img">
                                                <img class="img-fluid"
                                                    src="{{ asset('web_assets/images/product-img/1633835076_May252for$4SelectRTDs_Ecomm_Scroller_2.avif') }}"
                                                    alt="" title="">
                                            </div>
                                            <div class="bundle-title">
