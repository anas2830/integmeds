    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="hero-slider">
                <div class="items">
                    <img class="img-fluid" src="{{asset('web_assets/images/hero-img/Autoimmune.webp')}}" alt="" title="">
                </div>
                <div class="items">
                    <img class="img-fluid" src="{{asset('web_assets/images/hero-img/Cancer-Support.webp')}}" alt="" title="">
                </div>
                <div class="items">
                    <img class="img-fluid" src="{{asset('web_assets/images/hero-img/Childrens-Health.webp')}}" alt="" title="">
                </div>
                <div class="items">
                    <img class="img-fluid" src="{{asset('web_assets/images/hero-img/Diabetes.webp')}}" alt="" title="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-3 order-lg-1 order-2">
            ...
            <div class="sidebar-product-banner">
                <div class="sidebar-product-banner-img">
                    <img class="img-fluid" src="{{asset('web_assets/images/bg/New-Side-banner.png')}}" alt="" title="">
                </div>
                <div class="s-product-banner-text">
                    <h2>Integmeds New Arrivals</h2>
                    <p>At Integmeds, we are committed to enhancing your health and well-being through the power of nature, offering a range of organic and nutrient-dense products designed to support a holistic lifestyle, nurture vitality, and promote sustainable wellness.</p>
            ...
            <div class="sidebar-product-banner">
                <div class="sidebar-product-banner-img">
                    <img class="img-fluid" src="{{asset('web_assets/images/bg/New-Side-banner-4.png')}}" alt="" title="">
                </div>
                <div class="s-product-banner-text">
                    <h2>Integmeds New Arrivals</h2>
            ...
            <div class="sidebar-product-banner">
                <div class="sidebar-product-banner-img">
                    <img class="img-fluid" src="{{asset('web_assets/images/bg/New-Banner-New-.png')}}" alt="" title="">
                </div>
                <div class="s-product-banner-text">
                                ...
                                <div class="common-product-box">
                                    ...
                                    <div class="common-products-info-wrap">
                                        <div class="comm-products-title">
                                            ...
                                            <p><a href="{{route('product-details')}}"> Diabetes, Insulin Resistance</a></p>
                                        </div>
                                        <div class="rating">
                                            <div class="rating-start">
                                                <i class="fa-solid fa-star"></i>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="common-btn-wrap d-flex justify-content-center mt-4">
                                <div class="common-btn-borders">
                                    <a class="common-btn" href="bundle.php">Load More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="offer-segment-img-wrap">
                             <div class="offer-segment-img">
                                <img class="img-fluid" src="{{asset('web_assets/images/bg/offer-segment-bg.png')}}" alt="" title="">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 d-flex align-items-center">
                                    <div class="offer-segment-text">
                                        ...
                                        <p>Your go-to pre-workout for intense energy, focus, and pumps in flavors that always deliver*.</p>
                                        <div class="common-btn-wrap mt-4">
                                            <div class="common-btn-borders">
                                                <a class="common-btn" href="#">Shop Now</a>
                                            </div>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="offer-product-img">
                                        <img class="img-fluid" src="{{asset('web_assets/images/bg/offer-product.png')}}" alt="" title="">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="brand-banner">
                            <img class="img-fluid" src="{{asset('web_assets/images/bg/American-Number-1-Brand.png')}}" alt="" title="">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="special-product-wrap">
                            ...
                            <div class="special-product-text">
                                <h3>IMMUNE PLUS</h3>
                                <p>Elevate Your Health with Nature’s Finest, Nutrient-Packed Essentials for a Stronger, Balanced Immune System and Vibrant Well-Being</p>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="special-product-wrap">
                            ...
                            <div class="special-product-text">
                                ...
                                <p>Holistic, Natural Solutions to Promote and Maintain Optimal Gallbladder Function and Enhance Your Digestive Health for Long-Term Well-being</p>
                            </div>
                            <div class="common-btn-wrap mt-3 d-flex justify-content-center">
                                <div class="common-btn-borders">
                                    <a class="common-btn" href="#" >Shop Now</a>
                    ...
                    <div class="col-lg-4">
                        <div class="special-product-wrap">
                            ...
                            <div class="special-product-text">
                                <h3>DIGEST PRO</h3>
                                <p>Enhance Healthy Digestion and Inflammatory Support with Natural, Targeted Solutions for a Balanced and Comforted Digestive System</p>
                            </div>
                            <div class="common-btn-wrap mt-3 d-flex justify-content-center">
                                <div class="common-btn-borders">
                                    <a class="common-btn" href="#" >Shop Now</a>
