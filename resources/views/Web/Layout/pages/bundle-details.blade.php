                                    ...
                                    <div class="bundle-details-cart-plus-minus-and-pro-list">
                                        ...
                                        <div class="bundle-d-product-img-text-wrap">
                                            <a href="#">
                                                ...
                                                <div class="dundle-d-product-list-text">
                                                    <h4>Complete Detox Chocolate Flavored</h4>
                                                </div>
                                            </a>
                                        </div>
                                        <div class="bundle-d-price">
                        ...
                        <div class="col-12">
                            <div class="product-desc-wrap">
                                <ul class="nav nav-tabs" id="myTabTwo" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a href="#" class="nav-link" id="information-tab" data-bs-toggle="tab"
                                            data-bs-target="#recherche" role="tab" aria-controls="information"
                                            aria-selected="false">Recherche</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="tab-content" id="myTabContentTwo">
                                    ...
                                    <div class="tab-pane fade" id="recherche" role="tabpanel"
