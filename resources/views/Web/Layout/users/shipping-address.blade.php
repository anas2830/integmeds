                        ...
                        <form action="{{ route('user.shipping-address.update') }}" method="post">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="firstName" name="first_name" required value="{{ $shipping_address['first_name'] ?? '' }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="lastName">Last Name <span class="required">*</span></label>
                                    <input type="text" class="form-control" id="lastName" name="last_name" required value="{{ $shipping_address['last_name'] ?? '' }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Email <span class="required">*</span></label>
                                    <input type="email" class="form-control" placeholder="" required name="email" value="{{ $shipping_address['email'] ?? '' }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="form-label">Phone <span class="required">*</span></label>
                                    <input type="text" class="form-control" placeholder="" required name="phone" value="{{ $shipping_address['phone'] ?? '' }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="address" name="address_line1" placeholder="1234 Main St" required value="{{ $shipping_address['address_line1'] ?? '' }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="address2">Apartment, Suite, etc. <span class="text-muted">(Optional)</span></label>
                                    <input type="text" class="form-control" id="address2" name="address_line2" placeholder="Apartment or suite" value="{{ $shipping_address['address_line2'] ?? '' }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="city">City <span class="required">*</span></label>
                                    <input type="text" class="form-control" id="city" name="city" required value="{{ $shipping_address['city'] ?? '' }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="state">State/Province/Region <span class="required">*</span></label>
                                    <input type="text" class="form-control" id="state" name="state" required value="{{ $shipping_address['state'] ?? '' }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="zip">Postal / Zip Code <span class="required">*</span></label>
                                    <input type="text" class="form-control" id="zip" name="postal_code" required value="{{ $shipping_address['postal_code'] ?? '' }}">
                                </div>
