                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control w-100" name="name" value="{{ $editor['name'] }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="email" readonly class="form-control w-100" name="email" value="{{ $editor['email'] }}">
