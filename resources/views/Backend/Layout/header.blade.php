      ...
      <div class="d-flex">
          ...
          <div class="dropdown d-inline-block">
              <button type="button" class="btn header-item noti-icon waves-effect" id="page-header-notifications-dropdown"
                  ...
                  <span class="badge badge-danger badge-pill">{{pendingOrderCount()}}</span>
              </button>
              <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-0"
                      ...
                      <a href="#" class="text-reset notification-item">
                          <div class="media">
                              ...
                              <div class="media-body">
                                  <h6 class="mt-0 mb-1">New order is placed</h6>
                                  <div class="font-size-12 text-muted">
                                    <p class="mb-1">Please check the order list</p>
                                </div>
                              </div>
                          </div>
                      </a>
          ...
          <div class="dropdown d-inline-block">
              ...
              <div class="dropdown-menu dropdown-menu-right">
                    ...
                    @elseif(Auth::guard('editor')->check())
                        <a class="dropdown-item" href="{{ route('editor.profile') }}"><i class="bx bx-user font-size-16 align-middle mr-1"></i> Profile</a>
                    @endif
                ...
                @elseif(Auth::guard('editor')->check())
                  <a class="dropdown-item text-danger" href="{{ route('editor.logout') }}"><i class="bx bx-power-off font-size-16 align-middle mr-1 text-danger"></i> Logout</a>
                @endif
              </div>
          </div>
