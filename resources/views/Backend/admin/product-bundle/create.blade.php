...
@section('site-title', 'Create Product Bundle')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Create Product Bundle</h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('product-bundle.index') }}">Product Bundle</a></li>
                        <li class="breadcrumb-item active">Create Product Bundle</li>
                    </ol>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('product-bundle.store') }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <select name="bundle_products[]" class="form-control select2" multiple required>
                                                @foreach($products as $product)
                                                    <option value="{{ $product->id }}" 
                                                        {{ (collect(old('bundle_products'))->contains($product->id)) ? 'selected' : '' }}>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <p class="mb-3 font-weight-bold">Bundle icon <span class="text-danger">(1080 x 1080)</span></p>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <p class="mb-3 font-weight-bold">Bundle Images <span class="text-danger">(822 x 600)</span></p>
