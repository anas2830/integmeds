    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Edit Product Category</h4>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control w-100" name="category_name" value="{{ $productCategory->name }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control w-100 select2" name="parent_category_id">
                                        ...
                                        @foreach($parent_categories as $parent_category)
                                            <option value="{{ $parent_category->id }}" {{ $productCategory->parent_id == $parent_category->id ? 'selected' : '' }}>{{ $parent_category->name }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control w-100" name="description">{{ $productCategory->description }}</textarea>
                            ...
                            <div class="col-md-6 mt-4">
                                <div class="input-group input-group-dynamic">
                                    ...
                                    <div class="custom-control custom-switch custom-switch-lg mb-3" dir="ltr">
                                        <input type="checkbox" class="custom-control-input" id="customSwitchsizelg" value="1" name="status" {{ $productCategory->status == 1 ? 'checked' : '' }}>
