...
@section('main-content')
    ...
    <div class="row">
        <div class="col-12">
            <form method="POST" action="{{ route('privacy-policy-settings.update') }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <textarea id="content" name="content" class="form-control @error('content') is-invalid @enderror" rows="5">{{ $privacyPolicy->content }}</textarea>
                                    @error('content')
