...
@section('site-title', 'Bundle Review')
...
@push('custom-scripts')
<script>
    const approveReviewUrl = '{{ route('bundle-review.approve', ':id') }}';
    const deleteReviewUrl = '{{ route('bundle-review.destroy', ':id') }}';
                ...
                if(t.value){
                    $.ajax({
                        ...
                        error: function(xhr) {
                            Swal.fire({
                                title: "Error!",
                                text: "There was a problem deleting the bundle review.",
                            });
                        }
                    });
                }
