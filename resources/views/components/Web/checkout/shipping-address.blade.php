<div class="shipping-form-wrap">
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <select class="select2 form-control @error('shipping.country') is-invalid @enderror" name="shipping[country]" id="country" required style="width: 100%;">
                <option value="">Please choose your country/region</option>
                @foreach($countries as $country)
                    <option value="{{ $country->name }}"
                        {{ (old('shipping.country', $shippingAddress->country ?? '') === $country->name) ? 'selected' : '' }}>
                        {{ $country->name }}
                    </option>
                @endforeach
            </select>
